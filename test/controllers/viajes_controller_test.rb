...
class ViajesControllerTest < ActionController::TestCase
  ...
  test "should create viaje" do
    assert_difference('Viaje.count') do
      post :create, viaje: { distancia: @viaje.distancia, fecha: @viaje.fecha, id_viaje: @viaje.id_viaje, tiempo: @viaje.tiempo, user_id: @viaje.user_id }
    end
  ...
  test "should update viaje" do
    patch :update, id: @viaje, viaje: { distancia: @viaje.distancia, fecha: @viaje.fecha, id_viaje: @viaje.id_viaje, tiempo: @viaje.tiempo, user_id: @viaje.user_id }
    assert_redirected_to viaje_path(assigns(:viaje))
  end
